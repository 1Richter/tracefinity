    ...
    <>
      ...
      <div className="absolute inset-0 bg-inset flex items-center justify-center p-4">
        ...
        >
          ...
          {/* disabled partial-bin cells; the mask is row-major over whole
              cells, so a fractional grid still has ceil(grid) of them and the
              trailing cell is clipped to the bin edge */}
